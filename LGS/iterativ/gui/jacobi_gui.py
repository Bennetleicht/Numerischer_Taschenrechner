...
from jacobi_solver import Step as JacobiStep
from gui.base_lgs_iterativ_gui import BaseIterativGUI


class JacobiGUI(BaseIterativGUI):

    title_text      = "Jacobi-Verfahren"
    formula_label   = "Jacobi-Formel"
    _solution_title = "Jacobi-Ergebnis"
    formula_latex   = (
        r"$x_i^{(k+1)}"
        r" = \left( b_i"
    ...
    def _create_stepper(self, A, b, x0, tol):
        return JacobiStepper(A, b, x0, tol=tol, safety_limit=100)

    # Jacobi: alle Terme nutzen immer k_old
